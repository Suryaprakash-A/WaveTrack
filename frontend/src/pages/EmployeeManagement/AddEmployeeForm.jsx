...
import { createEmployeeAPI } from "../../services/employeeServices";
...
const AddEmployeeForm = ({ handleClose }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      roles: Yup.array()
        ...
        .required("Required"),
      remark: Yup.string().max(200, "Must be 200 characters or less"),
    }),
  ...
  // Force lowercase for email while typing
  const handleEmailChange = (e) => {
    formik.setFieldValue("email", e.target.value.toLowerCase());
  };

  // Only allow digits for contact
